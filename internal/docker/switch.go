...
func (c *switchCli) ContainerLogs(ctx context.Context, containerID string, options client.ContainerLogsOptions) (io.ReadCloser, error) {
...
func (c *switchCli) ContainerList(ctx context.Context, options client.ContainerListOptions) ([]typescontainer.Summary, error) {
...
func (c *switchCli) ImageList(ctx context.Context, options client.ImageListOptions) ([]typesimage.Summary, error) {
	return c.client(ctx).ImageList(ctx, options)
}
func (c *switchCli) ImageRemove(ctx context.Context, imageID string, options client.ImageRemoveOptions) ([]typesimage.DeleteResponse, error) {
...
func (c *switchCli) BuildCachePrune(ctx context.Context, opts client.BuildCachePruneOptions) (*typesbuild.CachePruneReport, error) {
	return c.client(ctx).BuildCachePrune(ctx, opts)
}
func (c *switchCli) ContainersPrune(ctx context.Context, pruneFilters client.Filters) (typescontainer.PruneReport, error) {
