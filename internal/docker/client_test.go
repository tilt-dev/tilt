...
func TestSupportsBuildkit(t *testing.T) {
	cases := []buildkitTestCase{
		{mobyclient.ServerVersionResult{APIVersion: "1.37", Experimental: true}, Env{}, false},
		{mobyclient.ServerVersionResult{APIVersion: "1.37", Experimental: false}, Env{}, false},
		{mobyclient.ServerVersionResult{APIVersion: "1.38", Experimental: true}, Env{}, true},
		{mobyclient.ServerVersionResult{APIVersion: "1.38", Experimental: false}, Env{}, false},
		{mobyclient.ServerVersionResult{APIVersion: "1.39", Experimental: true}, Env{}, true},
		{mobyclient.ServerVersionResult{APIVersion: "1.39", Experimental: false}, Env{}, true},
		{mobyclient.ServerVersionResult{APIVersion: "1.40", Experimental: true}, Env{}, true},
		{mobyclient.ServerVersionResult{APIVersion: "1.40", Experimental: false}, Env{}, true},
		{mobyclient.ServerVersionResult{APIVersion: "garbage", Experimental: false}, Env{}, false},
		{mobyclient.ServerVersionResult{APIVersion: "1.39", Experimental: true}, Env{IsOldMinikube: true}, false},
	}
