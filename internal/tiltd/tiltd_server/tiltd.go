...
func (d *Daemon) CreateService(ctx context.Context, k8sYaml string, dockerfile string, mounts []tiltd.Mount, steps []tiltd.Cmd, entrypoint tiltd.Cmd, dockerfileTag string, stdout io.Writer, stderr io.Writer) error {
