...
func TestPendingLocalResource(t *testing.T) {
	...
	v := newView(view.Resource{
		...
		ResourceInfo: view.NewLocalResourceInfo(model.RuntimeStatusPending, 0),
	})
...
func TestFinishedLocalResource(t *testing.T) {
	...
	v := newView(view.Resource{
		...
		ResourceInfo: view.NewLocalResourceInfo(model.RuntimeStatusNotApplicable, 0),
	})
...
func TestLocalResourceErroredServe(t *testing.T) {
	...
	v := newView(view.Resource{
		...
		ResourceInfo: view.NewLocalResourceInfo(model.RuntimeStatusError, 0),
	})
