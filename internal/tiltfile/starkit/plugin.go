...
//
// To play more nicely with Starlark, Starkit plugins manage state
// with an init/reduce pattern. That means each plugin should define:
//
...
// with the accumulated state from all plugins.
//
