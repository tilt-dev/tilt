...
import (
	...
	dockerprune2 "github.com/windmilleng/tilt/internal/engine/dockerprune"
...
func wireDemo(ctx context.Context, branch demo.RepoBranch, analytics2 *analytics.TiltAnalytics) (demo.Script, error) {
	...
	dockerpruneExtension := dockerprune.NewExtension()
	defaults := _wireDefaultsValue
	tiltfileLoader := tiltfile.ProvideTiltfileLoader(analytics2, client, extension, dockerpruneExtension, dockerComposeClient, defaults)
	...
	dockerPruner := dockerprune2.NewDockerPruner(switchCli)
...
func wireDownDeps(ctx context.Context, tiltAnalytics *analytics.TiltAnalytics) (DownDeps, error) {
	...
	dockerComposeClient := dockercompose.NewDockerComposeClient(localEnv)
	defaults := _wireDefaultsValue
	tiltfileLoader := tiltfile.ProvideTiltfileLoader(tiltAnalytics, client, extension, dockerpruneExtension, dockerComposeClient, defaults)
