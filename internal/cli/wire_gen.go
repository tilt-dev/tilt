...
func wireDemo(ctx context.Context, branch demo.RepoBranch, analytics2 *analytics.TiltAnalytics) (demo.Script, error) {
	...
	updateUploader := cloud.NewUpdateUploader(cloudHttpClient, address)
