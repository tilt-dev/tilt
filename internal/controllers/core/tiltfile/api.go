...
func toKubernetesApplyObjects(tlr *tiltfile.TiltfileLoadResult) apiset.TypedObjectSet {
...
func toImageMapObjects(tlr *tiltfile.TiltfileLoadResult) apiset.TypedObjectSet {
	result := apiset.TypedObjectSet{}
