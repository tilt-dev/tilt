...
func TestPortForwardDisabled(t *testing.T) {
	f := newFixtureWithPortForwards(t, false)
	...
	// Even though the KD has a port-forward template and a running pod, no
	// PortForward object should be created when port-forwards are disabled.
	var pf v1alpha1.PortForward
