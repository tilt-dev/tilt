...
func init() {
	proto1.RegisterType((*Service)(nil), "tiltd.Service")
	proto1.RegisterType((*CreateServiceReply)(nil), "tiltd.CreateServiceReply")
}
...
func (c *daemonClient) CreateService(ctx context.Context, in *Service, opts ...grpc.CallOption) (*CreateServiceReply, error) {
	...
	err := grpc.Invoke(ctx, "/tiltd.Daemon/CreateService", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Daemon_CreateService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tiltd.Daemon/CreateService",
	}
...
var _Daemon_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/tiltd.proto",
}

func init() { proto1.RegisterFile("proto/tiltd.proto", fileDescriptor0) }
