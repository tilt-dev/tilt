...
func (*Service) Descriptor() ([]byte, []int) {
	return fileDescriptor_daemon_2aea3b27b594abb0, []int{0}
}
...
func (*Cmd) Descriptor() ([]byte, []int) {
	return fileDescriptor_daemon_2aea3b27b594abb0, []int{1}
}
...
func (*Mount) Descriptor() ([]byte, []int) {
	return fileDescriptor_daemon_2aea3b27b594abb0, []int{2}
}
...
func (*Repo) Descriptor() ([]byte, []int) {
	return fileDescriptor_daemon_2aea3b27b594abb0, []int{3}
}
...
func (*GitRepo) Descriptor() ([]byte, []int) {
	return fileDescriptor_daemon_2aea3b27b594abb0, []int{4}
}
...
func (*CreateServiceReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_daemon_2aea3b27b594abb0, []int{5}
}
...
func init() { proto.RegisterFile("internal/proto/daemon.proto", fileDescriptor_daemon_2aea3b27b594abb0) }

var fileDescriptor_daemon_2aea3b27b594abb0 = []byte{
