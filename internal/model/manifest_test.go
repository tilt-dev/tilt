...
var equalitytests = []struct {
	...
	{
		Manifest{}.WithResourceInfo(DCInfo{ConfigPath: "/src/docker-compose.yml"}),
		Manifest{}.WithResourceInfo(DCInfo{ConfigPath: "/src/docker-compose.yml"}),
		true,
	},
	{
		Manifest{}.WithResourceInfo(DCInfo{ConfigPath: "/src/docker-compose1.yml"}),
		Manifest{}.WithResourceInfo(DCInfo{ConfigPath: "/src/docker-compose2.yml"}),
		false,
	},
	{
		Manifest{}.WithResourceInfo(DCInfo{YAMLRaw: []byte("hello world")}),
		Manifest{}.WithResourceInfo(DCInfo{YAMLRaw: []byte("hello world")}),
		true,
	},
	{
		Manifest{}.WithResourceInfo(DCInfo{YAMLRaw: []byte("hello world")}),
		Manifest{}.WithResourceInfo(DCInfo{YAMLRaw: []byte("goodbye world")}),
		false,
	},
	{
		Manifest{}.WithResourceInfo(DCInfo{DfRaw: []byte("hello world")}),
		Manifest{}.WithResourceInfo(DCInfo{DfRaw: []byte("hello world")}),
		true,
	},
	{
		Manifest{}.WithResourceInfo(DCInfo{DfRaw: []byte("hello world")}),
		Manifest{}.WithResourceInfo(DCInfo{DfRaw: []byte("goodbye world")}),
		false,
	},
}
