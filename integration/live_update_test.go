...
func TestLiveUpdate(t *testing.T) {
	...
	defer cancel()
	oneUpPods := f.WaitForAllPodsReady(ctx, "app=live-update")

	f.ForwardPort("deployment/live-update", "31234:8000")
	...
	twoUpPods := f.WaitForAllPodsReady(ctx, "app=live-update")
