...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DefaultRegistryOptions) DeepCopyInto(out *DefaultRegistryOptions) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DefaultRegistryOptions.
func (in *DefaultRegistryOptions) DeepCopy() *DefaultRegistryOptions {
	if in == nil {
		return nil
	}
	out := new(DefaultRegistryOptions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KubernetesClusterConnection) DeepCopyInto(out *KubernetesClusterConnection) {
	*out = *in
	if in.DefaultRegistryOptions != nil {
		in, out := &in.DefaultRegistryOptions, &out.DefaultRegistryOptions
		*out = new(DefaultRegistryOptions)
		**out = **in
	}
	return
