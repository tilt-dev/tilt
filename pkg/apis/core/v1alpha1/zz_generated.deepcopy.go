...
func (in *CancelOnSpec) DeepCopyInto(out *CancelOnSpec) {
	*out = *in
	in.CancelAfter.DeepCopyInto(&out.CancelAfter)
	if in.UIButtons != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CancelOnSpec.
func (in *CancelOnSpec) DeepCopy() *CancelOnSpec {
	if in == nil {
		return nil
	}
	out := new(CancelOnSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TiltfileSpec) DeepCopyInto(out *TiltfileSpec) {
	*out = *in
	...
	if in.CancelOn != nil {
		in, out := &in.CancelOn, &out.CancelOn
		*out = new(CancelOnSpec)
		(*in).DeepCopyInto(*out)
	}
	return
