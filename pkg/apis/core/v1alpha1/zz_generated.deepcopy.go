...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WatchDef) DeepCopyInto(out *WatchDef) {
	*out = *in
	if in.Paths != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WatchDef.
func (in *WatchDef) DeepCopy() *WatchDef {
	if in == nil {
		return nil
	}
	out := new(WatchDef)
