...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LiveUpdateInitialSync) DeepCopyInto(out *LiveUpdateInitialSync) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LiveUpdateInitialSync.
func (in *LiveUpdateInitialSync) DeepCopy() *LiveUpdateInitialSync {
	if in == nil {
		return nil
	}
	out := new(LiveUpdateInitialSync)
	in.DeepCopyInto(out)
	return out
}
