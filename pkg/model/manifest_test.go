...
var equalitytests = []struct {
	...
	{
		"LocalTarget equal",
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToShellCmd("beep boop"), "path/to/tiltfile", []string{"bar", "baz"}, Cmd{})),
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToShellCmd("beep boop"), "path/to/tiltfile", []string{"bar", "baz"}, Cmd{})),
		true,
		false,
	},
	{
		...
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToShellCmd("beep boop"), "path/to/tiltfile", []string{"bar", "baz"}, Cmd{})),
		Manifest{}.WithDeployTarget(NewLocalTarget("foooooo", ToShellCmd("beep boop"), "path/to/tiltfile", []string{"bar", "baz"}, Cmd{})),
		false,
		true,
	},
	{
		...
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToShellCmd("beep boop"), "path/to/tiltfile", []string{"bar", "baz"}, Cmd{})),
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToShellCmd("bippity boppity"), "path/to/tiltfile", []string{"bar", "baz"}, Cmd{})),
		false,
		true,
	},
	{
		...
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToShellCmd("beep boop"), "path/to/tiltfile", []string{"bar", "baz"}, Cmd{})),
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToShellCmd("beep boop"), "path/to/tiltfile", []string{"quux", "baz"}, Cmd{})),
		false,
		true,
	},
	{
		...
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToShellCmd("beep boop"), "path/to/tiltfile", []string{"bar", "baz"}, Cmd{})),
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToShellCmd("beep boop"), "some/other/path", []string{"bar", "baz"}, Cmd{})),
		false,
		true,
	},
}
