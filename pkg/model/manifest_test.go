...
var equalitytests = []struct {
	...
	{
		"DockerCompose.ConfigYAML equal",
		Manifest{}.WithDeployTarget(DockerComposeTarget{ConfigYAML: []byte("hello world")}),
		Manifest{}.WithDeployTarget(DockerComposeTarget{ConfigYAML: []byte("hello world")}),
		true,
		false,
	},
	{
		"DockerCompose.ConfigYAML unequal",
		Manifest{}.WithDeployTarget(DockerComposeTarget{ConfigYAML: []byte("hello world")}),
		Manifest{}.WithDeployTarget(DockerComposeTarget{ConfigYAML: []byte("goodbye world")}),
		false,
		true,
	},
	{
