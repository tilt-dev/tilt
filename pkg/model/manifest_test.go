...
var equalitytests = []struct {
	...
	{
		"ImageTarget.BuildRef unequal",
		Manifest{}.WithImageTarget(ImageTarget{Refs: container.RefSet{BuildRef: img1.AsNamedOnly()}}),
		Manifest{}.WithImageTarget(ImageTarget{Refs: container.RefSet{BuildRef: img2.AsNamedOnly()}}),
		false,
		true,
	},
	{
		"ImageTarget.BuildRef equal",
		Manifest{}.WithImageTarget(ImageTarget{Refs: container.RefSet{BuildRef: img1.AsNamedOnly()}}),
		Manifest{}.WithImageTarget(ImageTarget{Refs: container.RefSet{BuildRef: img1.AsNamedOnly()}}),
		true,
		false,
	...
	{
		"ImageTarget.DeployRef unequal",
		Manifest{}.WithImageTarget(ImageTarget{Refs: container.RefSet{DeployRef: img1.AsNamedOnly()}}),
		Manifest{}.WithImageTarget(ImageTarget{Refs: container.RefSet{DeployRef: img2.AsNamedOnly()}}),
		false,
		true,
	},
	{
		"ImageTarget.DeployRef equal",
		Manifest{}.WithImageTarget(ImageTarget{Refs: container.RefSet{DeployRef: img1.AsNamedOnly()}}),
		Manifest{}.WithImageTarget(ImageTarget{Refs: container.RefSet{DeployRef: img1.AsNamedOnly()}}),
		true,
		false,
