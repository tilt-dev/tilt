import {
    ...
    getResourceAlerts, numberOfAlerts,
    PodRestartErrorType,
    PodStatusErrorType, WarningErrorType
} from "./alerts";
...
describe("getResourceAlerts", () => {
    it("shows that a pod status of error is an alert", () =>{
        ...
        let expectedAlerts: Array<Alert> = [
            {alertType: PodStatusErrorType, msg: "I'm a pod in Error", timestamp: "", titleMsg: ""},
        ]
    ...
    it("should show pod restart alert", () => {
        ...
        let actual = getResourceAlerts(r)
        let expectedAlerts: Array<Alert> = [
            {alertType: PodRestartErrorType, msg: "", timestamp: "", titleMsg: "Restarts: 1"},
        ]
        expect(actual).toEqual(expectedAlerts);
    })
    ...
    it("should show the first build alert", () => {
        ...
        let actual = getResourceAlerts(r)
        let expectedAlerts: Array<Alert> = [
            {alertType: BuildFailedErrorType, msg: "Build error log", timestamp: "", titleMsg: "Build error"},
        ]
        expect(actual).toEqual(expectedAlerts);
    })
    ...
    it("should show a crash rebuild alert  using the first build info", () => {
        ...
        let actual = getResourceAlerts(r)
        let expectedAlerts: Array<Alert> = [
            {alertType: CrashRebuildErrorType, msg: "Hello I am a crash log", timestamp: "", titleMsg: "Pod crashed"},
        ]
        expect(actual).toEqual(expectedAlerts);
    })
    ...
    it("should show a warning alert  using the first build history", () => {
        ...
        let actual = getResourceAlerts(r)
        let expectedAlerts: Array<Alert> = [
            {alertType: WarningErrorType, msg: "Hi i'm a warning", timestamp: "10:00am", titleMsg: "test"},
        ]
        expect(actual).toEqual(expectedAlerts);
    })
    ...
    it("should show a pod restart alert and a build failed alert", ()=> {
        ...
        r.BuildHistory = [ // triggers build failed alert
            {
                Log: "Build error log"
            },
            {
    ...
    it("should show 3 alerts: 1 crash rebuild alert, 1 build failed alert, 1 warning alert ", () => {
       ...
       r.BuildHistory  = [
        ...
        let expectedAlerts: Array<Alert> = [
            {alertType: CrashRebuildErrorType, msg: "Hello I am a crash log", timestamp: "", titleMsg: "Pod crashed"},
            {alertType: BuildFailedErrorType, msg: "Build failed log", timestamp: "", titleMsg: "Build error"},
            {alertType: WarningErrorType, msg: "Hi I am a warning", timestamp: "10:00am", titleMsg: "test"},
